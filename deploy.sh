...
# main config
PLUGINSLUG="force-plugin-updates-check" # returns basename of current directory
CURRENTDIR=`pwd`
MAINFILE="force-plugin-updates-check.php" # this should be the name of your main php file in the wordpress plugin
